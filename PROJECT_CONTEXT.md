...
## V33 — 16.09.2026
- Удалён дублирующий переключатель языка внутри статей; переключатель остаётся только в шапке.
- Комментарии HTML/CSS/JS переведены на русский язык.
- 15.09.2026 добавлена пластинка John Coltrane & Johnny Hartman и статья с YouTube-видео.
- Альбом добавлен в коллекцию винила.


## V34
- Блог отображается только как единая хронология; отдельный каталог статей удалён.
- У каждой записи хронологии есть изображение; ссылки на развёрнутые статьи находятся внутри соответствующей записи.
- На стартовой странице ADR UAN выбор языка удалён; язык выбирается уже внутри сайта.
- Обновлены YouTube embed-ссылки Coltrane, Xenopixel, Asteria и HIWY Live; видео «Ачивка» удалено.


## V35 — новые покупки в хронологии
- 1MORE ComfoBuds Mini — октябрь 2022.
